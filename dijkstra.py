            ...
            for j in range(self.E):
                if(self.graph[j][0]==u):
                    if(mst[(self.graph[j][1])]==False):
                        if((self.graph[j][2]+key[u])<key[self.graph[j][1]]):
                            key[self.graph[j][1]]=self.graph[j][2]+key[u]
                            #print key
                            min_w=j
                            #print minw,min_w
                ...
                if(self.graph[j][1]==u):
                    if(mst[(self.graph[j][0])]==False):
                        if((self.graph[j][2]+key[u])<key[self.graph[j][0]]):
                            key[self.graph[j][0]]=self.graph[j][2]+key[u]
                            min_w=j
                            #print minw,min_w
